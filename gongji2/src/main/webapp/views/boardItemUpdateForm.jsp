    ...
    <form method="post" action="/boardItem/update">
      <table class="table-update">
        ...
        <tr>
          ...
          <td colspan="3">
            <input type="text" name="title" size="62" maxlength="70" value="${boardItem.title}">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td colspan="3">
            <textarea name="content" cols="70" row="600">${boardItem.content}</textarea>
          </td>
        </tr>
        <tr>
          <td class="title"><b>원글</b></td>
          <td colspan="3">
            <input type="number" name="rootid" value="${boardItem.rootid}" readonly>
          </td>
        </tr>
        <tr>
          <td class="title"><b>댓글 수준</b></td>
          <td>
            <input type="number" name="relevel" value="${boardItem.relevel}" readonly>
          </td>
          <td class="title"><b>댓글 순서</b></td>
          <td>
            <input type="number" name="recnt" value="${boardItem.recnt}" readonly>
          </td>
        </tr>
      </table>
      ...
      <div class="div-button">
        ...
        <input type="button" value="취소" onclick="location.href='/boardItem/list'">
      </div>
    </form>
  </div>
</body>
