			...
			<table class="table-input">
				<tr>
					...
					<td width="450px" colspan="3">
						${newsSubReplyItem.newsBoardItem.id}</td>
				</tr>
				<tr>
					<td class="title"><b>댓글 번호</b></td>
					<td width="450px" colspan="3">${newsSubReplyItem.id}</td>
				</tr>
				<tr>
					<td class="title"><b>작성자</b></td>
					<td colspan="3">${newsSubReplyItem.writer}</td>
				</tr>
				<tr>
					<td class="title"><b>일자</b></td>
					<td colspan="3">${newsSubReplyItem.date}</td>
				</tr>
				<tr>
					<td class="title"><b>내용</b></td>
					<td colspan="3"><textarea name="content" cols="70" row="600">${newsSubReplyItem.content}</textarea>
					</td>
				</tr>
			</table>
