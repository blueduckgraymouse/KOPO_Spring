		...
		<form method="post" action="/replyItem/sub/insert">
			<table class="table-input">
				<tr>
					...
					<td width="450px" colspan="3">${replyId} <input type="hidden"
						name="rootReplyId" value="${replyId}">
					</td>
				</tr>
				<tr>
					<td class="title"><b>일자</b></td>
					<td colspan="3"><span id="current_date"></span></td>
				</tr>
				<tr>
					<td class="title"><b>작성자</b></td>
					<td colspan="3"><input type="text" name="writer" size="70"
						maxlength="70"></td>
				</tr>
				<tr>
					<td class="title"><b>내용</b></td>
					<td colspan="3"><textarea name="content" cols="70" row="600"></textarea>
					</td>
				</tr>
			</table>
